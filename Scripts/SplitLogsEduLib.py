...
#    ('ITES\.1','ITES-A2015.txt'), # TEKPHY3 - TEKPHY - Analyse du mouvement - Universite de Montreal    24 Mai 2017    30 Juil 2017    TEKPHY3        course-v1:UMontreal+TEKPHY3+P2017    course-v1:UMontreal+TEKPHY3+P2017


    ('(course|block)-v1(:|(%3A)|(%253A))HEC([\+ ]|(%2[B0])|(%252B))ENT-102\.3([\+ ]|(%2[B0])|(%252B))A2016','ENT-102.3-A2016.txt'), # ENT-102.3 - Reussir son demarrage d'entreprise - L'approche SynOpp - HEC Montreal        14 nov 2016    19 juin 2017    ENT-102.3    course-v1:HEC+ENT-102.3+A2016        course-v1:HEC+ENT-102.3+A2016
    ('(course|block)-v1(:|(%3A)|(%253A))UMontreal([\+ ]|(%2[B0])|(%252B))IFT-Info-Theo([\+ ]|(%2[B0])|(%252B))H2016','IFT-Info-Theo-H2016.txt'), # IFT-Limites - Vers les limites ultimes de l'informatique - Universite de Montreal    26 fevr 2017    28 mai 2017    IFT-Limites    course-v1:UMontreal+IFT-Info-Theo+H2016    course-v1:UMontreal+IFT-Info-Theo+H2016
    ...
    ('(course|block)-v1(:|(%3A)|(%253A))HEC([\+ ]|(%2[B0])|(%252B))ENT-103\.1([\+ ]|(%2[B0])|(%252B))H2017','ENT-103.1-H2017.txt'), # ENT-103.1 - Entrepreneuriat familial - HEC Montreal        13 mars 2017    30 juin 2017    ENT-103.1    course-v1:HEC+ENT-103.1+H2017        course-v1:HEC+ENT-103.1+H2017
    ('(course|block)-v1(:|(%3A)|(%253A))UMontreal([\+ ]|(%2[B0])|(%252B))PRC\.3([\+ ]|(%2[B0])|(%252B))P2017','PRC.3-P2017.txt'), # PRC.3 - Processus de raisonnement clinique - Universite de Montreal    01 avr 2017    13 mai 2017    PRC.3        course-v1:UMontreal+PRC.3+P2017        course-v1:UMontreal+PRC.3+P2017
    ('(course|block)-v1(:|(%3A)|(%253A))UMontreal([\+ ]|(%2[B0])|(%252B))TEKPHY2([\+ ]|(%2[B0])|(%252B))P2017','TEKPHY2-P2017.txt'), # TEKPHY2 - TEKPHY - Activite physique et depense energetique - Universite de Montreal    5 Avril 2017    18 juin 2017    TEKPHY2        course-v1:UMontreal+TEKPHY2+P2017    course-v1:UMontreal+TEKPHY2+P2017
    ('(course|block)-v1(:|(%3A)|(%253A))UMontreal([\+ ]|(%2[B0])|(%252B))BRAMS\.2([\+ ]|(%2[B0])|(%252B))P2017','BRAMS.2-P2017.txt'), # BRAMS.2 - Neuroscience : parole et musique - UdeM et ULB (G3)    18 avr 2017    30 juin 2017    BRAMS.2        course-v1:UMontreal+BRAMS.2+P2017    course-v1:UMontreal+BRAMS.2+P2017

    ('(course|block)-v1(:|(%3A)|(%253A))PolyMtl([\+ ]|(%2[B0])|(%252B))CHE102([\+ ]|(%2[B0])|(%252B))P2017','CHE102-P2017.txt'), # CHE102 - La chimie, en route vers le genie II - Polytechnique Montreal    19 Avril 2017    14 juin 2017    CHE102        course-v1:PolyMtl+CHE102+P2017        course-v1:PolyMtl+CHE102+P2017
    ('HEC([/\.]|(%2F)|(%252F))SC-102\.1([/\.]|(%2F)|(%252F))A2015','SC-102.1-A2015.txt'), # SC-102.1 - Decisions financieres et gestion budgetaire - HEC Montreal        30 avr 2017    2 juil 2017    SC-102.1    HEC/SC-102.1/A2015            HEC/SC-102.1/A2015
    ('(course|block)-v1(:|(%3A)|(%253A))UMontreal([\+ ]|(%2[B0])|(%252B))CRP\.1([\+ ]|(%2[B0])|(%252B))A2016','CRP.1-A2016.txt'), # CRP.1 - Clinical Reasoning Process - Universite de Montreal    01 mai 2017    12 juin 2017    CRP.1        course-v1:UMontreal+CRP.1+A2016        course-v1:UMontreal+CRP.1+A2016
    ('HEC([/\.]|(%2F)|(%252F))GRH-101([/\.]|(%2F)|(%252F))A2015','GRH-101-A2015.txt'), # GRH-101 - Gestion des conflits - HEC Montreal        16 Nov 2015 - A Votre Rythme    GRH-101        HEC/GRH-101/A2015            HEC/GRH-101/A2015
    ('HEC([/\.]|(%2F)|(%252F))GRH-101\.1([/\.]|(%2F)|(%252F))H2013','GRH-101.1-H2013.txt'), # GRH-101.1???
    ('HEC([/\.]|(%2F)|(%252F))MKT-101([/\.]|(%2F)|(%252F))H2015','MKT-101-H2015.txt'), # MKT-101 - Introduction au marketing -  HEC Montreal        29 Avril 2015 - A Votre Rythme    MKT-101        HEC/MKT-101/H2015            HEC/MKT-101/H2015
    ...
    ('(course|block)-v1(:|(%3A)|(%253A))UMontreal([\+ ]|(%2[B0])|(%252B))TEKPHY1([\+ ]|(%2[B0])|(%252B))H2017','TEKPHY1-H2017.txt'), # TEKPHY1 - TEKPHY - Equilibre postural - Universite de Montreal    15 fevr 2017    30 avr 2017    TEKPHY1        course-v1:UMontreal+TEKPHY1+H2017    course-v1:UMontreal+TEKPHY1+H2017
    ...
    ('(course|block)-v1(:|(%3A)|(%253A))HEC([\+ ]|(%2[B0])|(%252B))d101([\+ ]|(%2[B0])|(%252B))H2016','COL-101.1-H2016.txt'), # COL-101.1 - L'evaluation participative de projets concertes - Dynamo +  HEC Montreal    12 Avril 2016    27 juin 2016 - course-v1:HEC+d101+H2016        course-v1:HEC+d101+H2016
    ...
    ('(course|block)-v1(:|(%3A)|(%253A))PolyMtl([\+ ]|(%2[B0])|(%252B))CHE101\.2([\+ ]|(%2[B0])|(%252B))P2016','CHE101.2-P2016.txt'), # CHE101.2 - La chimie, en route vers le genie - Polytechnique Montreal    5 Avril 2016    07 juin 2016 - course-v1:PolyMtl+CHE101.2+P2016    course-v1:PolyMtl+CHE101.2+P2016
    ('(course|block)-v1(:|(%3A)|(%253A))HEC([\+ ]|(%2[B0])|(%252B))ENT-101\.2([\+ ]|(%2[B0])|(%252B))H2016','ENT-101.2-H2016.txt'), # ENT-101.2 - L'esprit entrepreneurial - HEC Montreal        21 Mars 2016    26 mai 2016 - course-v1:HEC+ENT-101.2+H2016        course-v1:HEC+ENT-101.2+H2016
    ...
    ('(course|block)-v1(:|(%3A)|(%253A))PolyMtl([\+ ]|(%2[B0])|(%252B))CHE101\.1([\+ ]|(%2[B0])|(%252B))E2015','CHE101.1-E2015.txt'), # CHE101 - La chimie, en route vers le genie - Polytechnique Montreal    1 Nov 2015    12 janv 2016 - course-v1:PolyMtl+CHE101.1+E2015    course-v1:PolyMtl+CHE101.1+E2015
    ...
    ('HEC([/\.]|(%2F)|(%252F))ENT-102\.1([/\.]|(%2F)|(%252F))P2015','ENT-102.1-P2015.txt'), # ENT-102.1 - Reussir son demarrage d'entreprise - L'approche SynOpp - HEC Montreal        18 Mai 2015    28 juil 2015 - HEC/ENT-102.1/P2015            HEC/ENT-102.1/P2015
    ]
