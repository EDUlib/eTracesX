...
scriptsDict = {
     ...
     'C5': {'name': "OBSOLETE: modify_durations",
         'dirname': 'curation_scripts',
         'filename': 'new_modify_durations',
         'extension': '.py',
         'default': 0,
         'dependencies':[],
         'desc': "OBSOLETE: Fix the observed events duration"},
     ...
     5:  {'name': "-L- * average_length_of_forum_posts",
         'dirname': 'feat_extract_scripts',
         'filename': 'populate_feature_5_average_length_of_forum_posts',
         'extension': '.sql',
         'default': 0,
         'dependencies':[105],
         'desc': "-L- * Average length of forum posts during the week."},
     ...
     105:{'name': "-L- * difference_feature_5",
         'dirname': 'feat_extract_scripts',
         'filename': 'populate_feature_105_difference_feature_5',
         'extension': '.sql',
         'default': 0,
         'dependencies':[],
         'desc': "-L- * Average length of forum posts in current week divided by average length of forum posts in previous week, where number of forum posts in previous week is > 5 (difference of feature 5)."},
